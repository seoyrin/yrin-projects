...
public class AllOffDetail extends AppCompatActivity {
    //리스트에 해당하는 정보 불러오기
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_off_detail);

        initializewidgets();
        receiveAndShowData();

        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_all_off_detail);
