...
public class OnCouple extends AppCompatActivity {

    //on_couple_upload
    private static final String BASE_URL = "http://syr0527.cafe24.com";
    private static final String FULL_URL = BASE_URL+"/on_couple_upload.php"; //연결할 php파일
    ...
    interface MyAPIService {
        @GET("/on_couple_upload.php")
        Call<List<OnCouple.Online>> getOnlines();
    }
    ...
    class ListViewAdapter extends BaseAdapter {
        ...
        private List<OnCouple.Online> onlines;
        private Context context;

        public ListViewAdapter(Context context, List<OnCouple.Online> onlines) {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            final OnCouple.Online thisOnline = onlines.get(position);
        ...
        private void openDetailActivity(String[] data) {
            Intent intent = new Intent(OnCouple.this, OnCoupleDetail.class);
    ...
    private OnCouple.ListViewAdapter adapter;
    private ListView ListView1;

    private  void populateListView(List<OnCouple.Online> onlineList) {
        ListView1 = findViewById(R.id.ListView1);
        adapter = new OnCouple.ListViewAdapter(this,onlineList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_6couple);

        //on_couple_upload
        OnCouple.MyAPIService myAPIService = OnCouple.RetrofitClientInstance.getRetrofitInstance().create(OnCouple.MyAPIService.class);

        Call<List<OnCouple.Online>> call = myAPIService.getOnlines();
        call.enqueue(new Callback<List<OnCouple.Online>>() {

            @Override
            public void onResponse(Call<List<OnCouple.Online>> call, Response<List<OnCouple.Online>> response){
                populateListView(response.body());
            }
            @Override
            public  void onFailure(Call<List<OnCouple.Online>> call, Throwable throwable){
                Toast.makeText(OnCouple.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        } );

        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_on_6couple);
        drawerView = (View)findViewById(R.id.activity_menu);

        ImageButton menu_on_coup=(ImageButton)findViewById(R.id.menu_on_coup);
        menu_on_coup.setOnClickListener(new View.OnClickListener() {
            @Override
