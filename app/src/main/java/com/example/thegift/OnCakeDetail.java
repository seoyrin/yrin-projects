...
public class OnCakeDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_5cake_detail);

        initializewidgets();
        receiveAndShowData();

        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_on_5cake_detail);
