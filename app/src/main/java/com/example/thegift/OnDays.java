...
public class OnDays extends AppCompatActivity {

    //on_days_upload
    private static final String BASE_URL = "http://syr0527.cafe24.com";
    private static final String FULL_URL = BASE_URL+"/on_days_upload.php"; //연결할 php파일
    ...
    interface MyAPIService {
        @GET("/on_days_upload.php")
        Call<List<OnDays.Online>> getOnlines();
    }
    ...
    class ListViewAdapter extends BaseAdapter {
        ...
        private List<OnDays.Online> onlines;
        private Context context;

        public ListViewAdapter(Context context, List<OnDays.Online> onlines) {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            final OnDays.Online thisOnline = onlines.get(position);
        ...
        private void openDetailActivity(String[] data) {
            Intent intent = new Intent(OnDays.this, OnDaysDetail.class);
    ...
    private OnDays.ListViewAdapter adapter;
    private ListView ListView1;

    private  void populateListView(List<OnDays.Online> onlineList) {
        ListView1 = findViewById(R.id.ListView1);
        adapter = new OnDays.ListViewAdapter(this,onlineList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_2days);

        //on_days_upload
        OnDays.MyAPIService myAPIService = OnDays.RetrofitClientInstance.getRetrofitInstance().create(OnDays.MyAPIService.class);

        Call<List<OnDays.Online>> call = myAPIService.getOnlines();
        call.enqueue(new Callback<List<OnDays.Online>>() {

            @Override
            public void onResponse(Call<List<OnDays.Online>> call, Response<List<OnDays.Online>> response){
                populateListView(response.body());
            }
            @Override
            public  void onFailure(Call<List<OnDays.Online>> call, Throwable throwable){
                Toast.makeText(OnDays.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        } );
        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_on_2days);
        drawerView = (View)findViewById(R.id.activity_menu);

        ImageButton menu_on_days=(ImageButton)findViewById(R.id.menu_on_days);
        menu_on_days.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onButtonOfflineClicked(View v) {
        Intent intent = new Intent(getApplicationContext(), OffDays.class);
        startActivity(intent);
    }
