...
public class AllOff extends AppCompatActivity {
    //off_all_upload
    private static final String BASE_URL = "http://syr0527.cafe24.com";//"http://syr0527.cafe24.com";
    private static final String FULL_URL = BASE_URL+"/off_all_upload.php";
    ...
    interface MyAPIService {
        @GET("/off_all_upload.php")
        Call<List<AllOff.Offline>> getOfflines();
    }
    ...
    class ListViewAdapter extends BaseAdapter {
        ...
        private List<AllOff.Offline> offlines;
        private Context context;

        public ListViewAdapter(Context context, List<AllOff.Offline> offlines) {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            final AllOff.Offline thisOffline = offlines.get(position);
        ...
        private void openDetailActivity(String[] data) {
            Intent intent = new Intent(AllOff.this, AllOffDetail.class);
    ...
    private AllOff.ListViewAdapter adapter;
    private ListView ListView1;


    private  void populateListView(List<AllOff.Offline> offlineList) {
        ListView1 = findViewById(R.id.ListView1);
        adapter = new AllOff.ListViewAdapter(this,offlineList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AllOff.MyAPIService myAPIService = AllOff.RetrofitClientInstance.getRetrofitInstance().create(AllOff.MyAPIService.class);

        Call<List<AllOff.Offline>> call = myAPIService.getOfflines();
        call.enqueue(new Callback<List<AllOff.Offline>>() {

            @Override
            public void onResponse(Call<List<AllOff.Offline>> call, Response<List<AllOff.Offline>> response){
                populateListView(response.body());
            }
            @Override
            public  void onFailure(Call<List<AllOff.Offline>> call, Throwable throwable){
                Toast.makeText(AllOff.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        } );

        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_all_off);
