...
public class OffCake extends AppCompatActivity {
    ...
    private static final String FULL_URL = BASE_URL+"/off_cake_upload.php";
    ...
    interface MyAPIService {
        @GET("/off_cake_upload.php")
        Call<List<OffCake.Offline>> getOfflines();
    }
    ...
    class ListViewAdapter extends BaseAdapter {
        ...
        private List<OffCake.Offline> offlines;
        private Context context;

        public ListViewAdapter(Context context, List<OffCake.Offline> offlines) {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            final OffCake.Offline thisOffline = offlines.get(position);
        ...
        private void openDetailActivity(String[] data) {
            Intent intent = new Intent(OffCake.this, OffCakeDetail.class);
    ...
    private OffCake.ListViewAdapter adapter;
    private ListView ListView1;


    private  void populateListView(List<OffCake.Offline> offlineList) {
        ListView1 = findViewById(R.id.ListView1);
        adapter = new OffCake.ListViewAdapter(this,offlineList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_off_5cake);

        OffCake.MyAPIService myAPIService = OffCake.RetrofitClientInstance.getRetrofitInstance().create(OffCake.MyAPIService.class);

        Call<List<OffCake.Offline>> call = myAPIService.getOfflines();
        call.enqueue(new Callback<List<OffCake.Offline>>() {

            @Override
            public void onResponse(Call<List<OffCake.Offline>> call, Response<List<OffCake.Offline>> response){
                populateListView(response.body());
            }
            @Override
            public  void onFailure(Call<List<OffCake.Offline>> call, Throwable throwable){
                Toast.makeText(OffCake.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        } );

        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_off_5cake);
        drawerView = (View)findViewById(R.id.activity_menu);

        ImageButton menu_off_cake=(ImageButton)findViewById(R.id.menu_off_cake);
        menu_off_cake.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onButtonOfflineClicked(View v) {
        Intent intent = new Intent(getApplicationContext(), OffCake.class);
        startActivity(intent);
    }
