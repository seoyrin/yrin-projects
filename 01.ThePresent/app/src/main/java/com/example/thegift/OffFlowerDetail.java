...
public class OffFlowerDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_off_4flower_detail);

        initializewidgets();
        receiveAndShowData();

        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_off_4flower_detail);
