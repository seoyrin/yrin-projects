...
public class OffFlower extends AppCompatActivity {

    //off_flower_upload
    private static final String BASE_URL = "http://syr0527.cafe24.com";//"http://syr0527.cafe24.com";
    private static final String FULL_URL = BASE_URL+"/off_flower_upload.php";
    ...
    interface MyAPIService {
        @GET("/off_flower_upload.php")
        Call<List<OffFlower.Offline>> getOfflines();
    }
    ...
    class ListViewAdapter extends BaseAdapter {
        ...
        private List<OffFlower.Offline> offlines;
        private Context context;

        public ListViewAdapter(Context context, List<OffFlower.Offline> offlines) {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            final OffFlower.Offline thisOffline = offlines.get(position);
        ...
        private void openDetailActivity(String[] data) {
            Intent intent = new Intent(OffFlower.this, OffFlowerDetail.class);
    ...
    private OffFlower.ListViewAdapter adapter;
    private ListView ListView1;


    private  void populateListView(List<OffFlower.Offline> offlineList) {
        ListView1 = findViewById(R.id.ListView1);
        adapter = new OffFlower.ListViewAdapter(this,offlineList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_off_4flower);

        OffFlower.MyAPIService myAPIService = OffAnni.RetrofitClientInstance.getRetrofitInstance().create(OffFlower.MyAPIService.class);

        Call<List<OffFlower.Offline>> call = myAPIService.getOfflines();
        call.enqueue(new Callback<List<OffFlower.Offline>>() {

            @Override
            public void onResponse(Call<List<OffFlower.Offline>> call, Response<List<OffFlower.Offline>> response){
                populateListView(response.body());
            }
            @Override
            public  void onFailure(Call<List<OffFlower.Offline>> call, Throwable throwable){
                Toast.makeText(OffFlower.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        } );

        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_off_4flower);
        drawerView = (View)findViewById(R.id.activity_menu);

        ImageButton menu_off_flo=(ImageButton)findViewById(R.id.menu_off_flo);
        menu_off_flo.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onButtonOfflineClicked(View v) {
        Intent intent = new Intent(getApplicationContext(), OffFlower.class);
        startActivity(intent);
    }
