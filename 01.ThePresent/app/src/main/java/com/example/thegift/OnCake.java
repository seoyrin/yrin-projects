...
public class OnCake extends AppCompatActivity {
    //on_cake_upload
    private static final String BASE_URL = "http://syr0527.cafe24.com";
    private static final String FULL_URL = BASE_URL+"/on_cake_upload.php"; //연결할 php파일
    ...
    interface MyAPIService {
        @GET("/on_cake_upload.php")
        Call<List<OnCake.Online>> getOnlines();
    }
    ...
    class ListViewAdapter extends BaseAdapter {
        ...
        private List<OnCake.Online> onlines;
        private Context context;

        public ListViewAdapter(Context context, List<OnCake.Online> onlines) {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            final OnCake.Online thisOnline = onlines.get(position);
        ...
        private void openDetailActivity(String[] data) {
            Intent intent = new Intent(OnCake.this, OnCakeDetail.class);
    ...
    private OnCake.ListViewAdapter adapter;
    private ListView ListView1;

    private  void populateListView(List<OnCake.Online> onlineList) {
        ListView1 = findViewById(R.id.ListView1);
        adapter = new OnCake.ListViewAdapter(this,onlineList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_5cake);

        //on_cake_upload
        OnCake.MyAPIService myAPIService = OnCake.RetrofitClientInstance.getRetrofitInstance().create(OnCake.MyAPIService.class);

        Call<List<OnCake.Online>> call = myAPIService.getOnlines();
        call.enqueue(new Callback<List<OnCake.Online>>() {

            @Override
            public void onResponse(Call<List<OnCake.Online>> call, Response<List<OnCake.Online>> response){
                populateListView(response.body());
            }
            @Override
            public  void onFailure(Call<List<OnCake.Online>> call, Throwable throwable){
                Toast.makeText(OnCake.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        } );

        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_on_5cake);
        drawerView = (View)findViewById(R.id.activity_menu);

        ImageButton menu_on_cake=(ImageButton)findViewById(R.id.menu_on_cake);
        menu_on_cake.setOnClickListener(new View.OnClickListener() {
            @Override
