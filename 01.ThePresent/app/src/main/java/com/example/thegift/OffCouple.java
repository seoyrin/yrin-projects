...
public class OffCouple extends AppCompatActivity {

    //off_couple_upload
    private static final String BASE_URL = "http://syr0527.cafe24.com";//"http://syr0527.cafe24.com";
    private static final String FULL_URL = BASE_URL+"/off_couple_upload.php";
    ...
    interface MyAPIService {
        @GET("/off_couple_upload.php")
        Call<List<OffCouple.Offline>> getOfflines();
    }
    ...
    class ListViewAdapter extends BaseAdapter {
        ...
        private List<OffCouple.Offline> offlines;
        private Context context;

        public ListViewAdapter(Context context, List<OffCouple.Offline> offlines) {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            final OffCouple.Offline thisOffline = offlines.get(position);
        ...
        private void openDetailActivity(String[] data) {
            Intent intent = new Intent(OffCouple.this, OffCoupleDetail.class);
    ...
    private OffCouple.ListViewAdapter adapter;
    private ListView ListView1;


    private  void populateListView(List<OffCouple.Offline> offlineList) {
        ListView1 = findViewById(R.id.ListView1);
        adapter = new OffCouple.ListViewAdapter(this,offlineList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_off_6couple);

        OffCouple.MyAPIService myAPIService = OffCouple.RetrofitClientInstance.getRetrofitInstance().create(OffCouple.MyAPIService.class);

        Call<List<OffCouple.Offline>> call = myAPIService.getOfflines();
        call.enqueue(new Callback<List<OffCouple.Offline>>() {

            @Override
            public void onResponse(Call<List<OffCouple.Offline>> call, Response<List<OffCouple.Offline>> response){
                populateListView(response.body());
            }
            @Override
            public  void onFailure(Call<List<OffCouple.Offline>> call, Throwable throwable){
                Toast.makeText(OffCouple.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        } );

        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_off_6couple);
        drawerView = (View)findViewById(R.id.activity_menu);

        ImageButton menu_off_coup=(ImageButton)findViewById(R.id.menu_off_coup);
        menu_off_coup.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onButtonOfflineClicked(View v) {
        Intent intent = new Intent(getApplicationContext(), OffCouple.class);
        startActivity(intent);
    }
