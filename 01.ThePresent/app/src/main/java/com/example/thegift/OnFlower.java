...
public class OnFlower extends AppCompatActivity {

    //on_flower_upload
    private static final String BASE_URL = "http://syr0527.cafe24.com";
    private static final String FULL_URL = BASE_URL+"/on_flower_upload.php"; //연결할 php파일
    ...
    interface MyAPIService {
        @GET("/on_flower_upload.php")
        Call<List<OnFlower.Online>> getOnlines();
    }
    ...
    class ListViewAdapter extends BaseAdapter {
        ...
        private List<OnFlower.Online> onlines;
        private Context context;

        public ListViewAdapter(Context context, List<OnFlower.Online> onlines) {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            final OnFlower.Online thisOnline = onlines.get(position);
        ...
        private void openDetailActivity(String[] data) {
            Intent intent = new Intent(OnFlower.this, OnFlowerDetail.class);
    ...
    private OnFlower.ListViewAdapter adapter;
    private ListView ListView1;

    private  void populateListView(List<OnFlower.Online> onlineList) {
        ListView1 = findViewById(R.id.ListView1);
        adapter = new OnFlower.ListViewAdapter(this,onlineList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_4flower);

        //on_anni_upload
        OnFlower.MyAPIService myAPIService = OnFlower.RetrofitClientInstance.getRetrofitInstance().create(OnFlower.MyAPIService.class);

        Call<List<OnFlower.Online>> call = myAPIService.getOnlines();
        call.enqueue(new Callback<List<OnFlower.Online>>() {

            @Override
            public void onResponse(Call<List<OnFlower.Online>> call, Response<List<OnFlower.Online>> response){
                populateListView(response.body());
            }
            @Override
            public  void onFailure(Call<List<OnFlower.Online>> call, Throwable throwable){
                Toast.makeText(OnFlower.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        } );

        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_on_4flower);
        drawerView = (View)findViewById(R.id.activity_menu);

        ImageButton menu_on_flo=(ImageButton)findViewById(R.id.menu_on_flo);
        menu_on_flo.setOnClickListener(new View.OnClickListener() {
            @Override
