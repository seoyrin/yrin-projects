...
public class OnAnni extends AppCompatActivity {
    ...
    private static final String FULL_URL = BASE_URL+"/on_anni_upload.php"; //연결할 php파일
    ...
    class ListViewAdapter extends BaseAdapter {
        ...
        public ListViewAdapter(Context context, List<Online> onlines) {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            final Online thisOnline = onlines.get(position);
        ...
        private void openDetailActivity(String[] data) {
            Intent intent = new Intent(OnAnni.this, OnAnniDetail.class);
    ...
    private  void populateListView(List<Online> onlineList) {
        ListView1 = findViewById(R.id.ListView1);
        adapter = new ListViewAdapter(this,onlineList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_1anni);

        //on_anni_upload
        MyAPIService myAPIService = RetrofitClientInstance.getRetrofitInstance().create(MyAPIService.class);

        Call<List<Online>> call = myAPIService.getOnlines();
        call.enqueue(new Callback<List<Online>>() {
            ...
            @Override
            public  void onFailure(Call<List<Online>> call, Throwable throwable){
                Toast.makeText(OnAnni.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        } );

        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_on_1anni);
        drawerView = (View)findViewById(R.id.activity_menu);

        ImageButton menu_on_anni=(ImageButton)findViewById(R.id.menu_on_anni);
        menu_on_anni.setOnClickListener(new View.OnClickListener() {
            @Override
