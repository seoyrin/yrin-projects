...
public class OffDays extends AppCompatActivity {
    ...
    private static final String FULL_URL = BASE_URL+"/off_days_upload.php";
    ...
    interface MyAPIService {
        @GET("/off_days_upload.php")
        Call<List<OffDays.Offline>> getOfflines();
    }
    ...
    class ListViewAdapter extends BaseAdapter {
        ...
        private List<OffDays.Offline> offlines;
        private Context context;

        public ListViewAdapter(Context context, List<OffDays.Offline> offlines) {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            final OffDays.Offline thisOffline = offlines.get(position);
        ...
        private void openDetailActivity(String[] data) {
            Intent intent = new Intent(OffDays.this, OffDaysDetail.class);
    ...
    private OffDays.ListViewAdapter adapter;
    private ListView ListView1;


    private  void populateListView(List<OffDays.Offline> offlineList) {
        ListView1 = findViewById(R.id.ListView1);
        adapter = new OffDays.ListViewAdapter(this,offlineList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_off_2days);

        OffDays.MyAPIService myAPIService = OffDays.RetrofitClientInstance.getRetrofitInstance().create(OffDays.MyAPIService.class);

        Call<List<OffDays.Offline>> call = myAPIService.getOfflines();
        call.enqueue(new Callback<List<OffDays.Offline>>() {

            @Override
            public void onResponse(Call<List<OffDays.Offline>> call, Response<List<OffDays.Offline>> response){
                populateListView(response.body());
            }
            @Override
            public  void onFailure(Call<List<OffDays.Offline>> call, Throwable throwable){
                Toast.makeText(OffDays.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        } );

        //menu (drawer) 중간
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_off_2days);
        drawerView = (View)findViewById(R.id.activity_menu);

        ImageButton menu_off_days=(ImageButton)findViewById(R.id.menu_off_days);
        menu_off_days.setOnClickListener(new View.OnClickListener() {
            @Override
